...
#pragma once
#ifndef CE_SHADER_DefaultShader_2882848193_H
#define CE_SHADER_DefaultShader_2882848193_H
...
#ifdef _MSC_VER
	#pragma comment(lib, "DefaultShader.lib")
#endif
	...
	namespace Shader {
		namespace DefaultShader {
			...
			inline namespace Shaders {
				...
				namespace DirectionalTransparent {
					void __fastcall GetVS(ShaderModel model, std::uint32_t waveSize, bool tessellation, std::uint32_t msaaCount, bool complex, const void** result, std::size_t* resultLength);
#ifdef CLOAKENGINE_VERSION
					inline CloakEngine::API::Rendering::SHADER_CODE CLOAK_CALL GetVS(In const CloakEngine::API::Rendering::SHADER_MODEL& model, In_opt std::uint32_t waveSize = 4, In_opt bool tessellation = false, In_opt std::uint32_t msaaCount = 1, In_opt bool complex = false)
					{
				...
				namespace Phase2LightAssignment {
					void __fastcall GetVS(ShaderModel model, std::uint32_t waveSize, bool tessellation, std::uint32_t msaaCount, bool complex, const void** result, std::size_t* resultLength);
#ifdef CLOAKENGINE_VERSION
					inline CloakEngine::API::Rendering::SHADER_CODE CLOAK_CALL GetVS(In const CloakEngine::API::Rendering::SHADER_MODEL& model, In_opt std::uint32_t waveSize = 4, In_opt bool tessellation = false, In_opt std::uint32_t msaaCount = 1, In_opt bool complex = false)
					{
				...
				namespace DirectionalShadowAlpha {
					void __fastcall GetVS(ShaderModel model, std::uint32_t waveSize, bool tessellation, std::uint32_t msaaCount, bool complex, const void** result, std::size_t* resultLength);
#ifdef CLOAKENGINE_VERSION
					inline CloakEngine::API::Rendering::SHADER_CODE CLOAK_CALL GetVS(In const CloakEngine::API::Rendering::SHADER_MODEL& model, In_opt std::uint32_t waveSize = 4, In_opt bool tessellation = false, In_opt std::uint32_t msaaCount = 1, In_opt bool complex = false)
					{
				...
				namespace Phase2ClusterCompression {
					void __fastcall GetVS(ShaderModel model, std::uint32_t waveSize, bool tessellation, std::uint32_t msaaCount, bool complex, const void** result, std::size_t* resultLength);
#ifdef CLOAKENGINE_VERSION
					inline CloakEngine::API::Rendering::SHADER_CODE CLOAK_CALL GetVS(In const CloakEngine::API::Rendering::SHADER_MODEL& model, In_opt std::uint32_t waveSize = 4, In_opt bool tessellation = false, In_opt std::uint32_t msaaCount = 1, In_opt bool complex = false)
					{
				...
				namespace DirectionalShadowOpaque {
					void __fastcall GetVS(ShaderModel model, std::uint32_t waveSize, bool tessellation, std::uint32_t msaaCount, bool complex, const void** result, std::size_t* resultLength);
#ifdef CLOAKENGINE_VERSION
					inline CloakEngine::API::Rendering::SHADER_CODE CLOAK_CALL GetVS(In const CloakEngine::API::Rendering::SHADER_MODEL& model, In_opt std::uint32_t waveSize = 4, In_opt bool tessellation = false, In_opt std::uint32_t msaaCount = 1, In_opt bool complex = false)
					{
				...
				namespace Phase2ClusterAssignment {
					void __fastcall GetVS(ShaderModel model, std::uint32_t waveSize, bool tessellation, std::uint32_t msaaCount, bool complex, const void** result, std::size_t* resultLength);
#ifdef CLOAKENGINE_VERSION
					inline CloakEngine::API::Rendering::SHADER_CODE CLOAK_CALL GetVS(In const CloakEngine::API::Rendering::SHADER_MODEL& model, In_opt std::uint32_t waveSize = 4, In_opt bool tessellation = false, In_opt std::uint32_t msaaCount = 1, In_opt bool complex = false)
					{
...
//Namespace Alias:
namespace DefaultShader = CloakEngine::Shader::DefaultShader;
