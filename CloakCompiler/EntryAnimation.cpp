		...
		namespace Image {
			namespace v1008 {
				namespace EntryAnimation_v1 {
					...
					void CLOAK_CALL_THIS EntryAnimation::WriteLibFiles(In const CE::RefPointer<CloakEngine::Files::IWriter>& file, In const API::Image::LibInfo& lib, In size_t entryID, In const Lib::CMakeFile& cmake, In const CE::Global::Task& finishTask)
					{
