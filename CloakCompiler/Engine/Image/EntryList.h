#pragma once
#ifndef CC_E_IMAGE_ENTRYLIST_H
#define CC_E_IMAGE_ENTRYLIST_H
	...
	namespace Engine {
		namespace Image {
			inline namespace v1008 {
				inline namespace EntryList_v1 {
					class EntryList : public IEntry {
						private:
							API::Image::v1008::ColorChannel m_channel;
							bool m_alphaMap;
							API::Image::SizeFlag m_sizeFlag;
						...
						public:
							CLOAK_CALL EntryList(In const API::Image::v1008::IMAGE_INFO_LIST& img, In const ResponseCaller& response, In size_t imgNum, In uint8_t qualityOffset, In API::Image::v1008::Heap heap);
							virtual CLOAK_CALL ~EntryList();
