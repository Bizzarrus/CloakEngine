#pragma once
#ifndef CC_E_IMAGE_ENTRYANIMATION_H
#define CC_E_IMAGE_ENTRYANIMATION_H
	...
	namespace Engine {
		namespace Image {
			inline namespace v1008 {
				inline namespace EntryAnimation_v1 {
					class EntryAnimation : public IEntry {
					private:
						struct AnimationMipTexture {
							MipTexture Texture;
							CloakEngine::Global::Time ShowTime;
						};
						API::Image::v1008::ColorChannel m_channel;
						bool m_alphaMap;
						AnimationMipTexture* m_textures;
						TextureMeta* m_metas;
						size_t m_texCount;
					...
					public:
						CLOAK_CALL EntryAnimation(In const API::Image::v1008::IMAGE_INFO_ANIMATION& img, In const ResponseCaller& response, In size_t imgNum, In uint8_t qualityOffset, In API::Image::v1008::Heap heap);
						virtual CLOAK_CALL ~EntryAnimation();
