#pragma once
#ifndef CC_E_IMAGE_ENTRYCUBE_H
#define CC_E_IMAGE_ENTRYCUBE_H
	...
	namespace Engine {
		namespace Image {
			inline namespace v1008 {
				inline namespace EntryCube_v1 {
					class EntryCube : public IEntry {
					private:
					...
					public:
						CLOAK_CALL EntryCube(In const API::Image::v1008::IMAGE_INFO_CUBE& img, In const ResponseCaller& response, In size_t imgNum, In uint8_t qualityOffset, In API::Image::v1008::Heap heap);
						virtual CLOAK_CALL ~EntryCube();
